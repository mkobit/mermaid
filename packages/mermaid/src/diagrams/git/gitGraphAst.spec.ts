...
describe('gitGraph links', () => {
  ...
  describe('setLink', () => {
    it('should store a basic link', () => {
      db.setLink('commit1', 'https://example.com', undefined, undefined, 'commit');
    ...
    it('should store tooltip when provided', () => {
      db.setLink('commit1', 'https://example.com', 'My tooltip', undefined, 'commit');
      expect(db.getLink('commit1')?.tooltip).toBe('My tooltip');
    });

    it('should store target when provided', () => {
      db.setLink('commit1', 'https://example.com', undefined, '_blank', 'commit');
      expect(db.getLink('commit1')?.target).toBe('_blank');
    });

    it('should store all options together', () => {
      db.setLink('commit1', 'https://example.com', 'Tooltip', '_blank', 'commit');
    ...
    it('should overwrite existing link for same id', () => {
      db.setLink('commit1', 'https://old.com', undefined, undefined, 'commit');
      db.setLink('commit1', 'https://new.com', undefined, undefined, 'commit');
      expect(db.getLink('commit1')?.link).toBe('https://new.com');
    });

    it('should handle special characters in commit id', () => {
      db.setLink('v1.0.0-beta', 'https://example.com', undefined, undefined, 'commit');
  ...
  describe('getLinks', () => {
    ...
    it('should return all stored links', () => {
      db.setLink('c1', 'https://example.com/1', undefined, undefined, 'commit');
      db.setLink('c2', 'https://example.com/2', undefined, undefined, 'commit');
    ...
    it('should return a copy (not original map)', () => {
      db.setLink('c1', 'https://example.com', undefined, undefined, 'commit');
  ...
  describe('clear', () => {
    it('should clear all links', () => {
      db.setLink('c1', 'https://example.com', undefined, undefined, 'commit');
      db.setLink('c2', 'https://example.com', undefined, undefined, 'commit');
      clear();
      expect(db.getLinks().size).toBe(0);
    });
  });
